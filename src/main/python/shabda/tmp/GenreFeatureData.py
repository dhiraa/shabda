...
class GenreFeatureData:
    ...
    hop_length = None
    genre_list = ['up' ,'down', 'left', 'right']

    dir_trainfolder = "/tmp/shabda/data/train/"
    dir_devfolder = "/tmp/shabda/data/train/"
    dir_testfolder = "/tmp/shabda/data/train/"
    dir_all_files = "/tmp/shabda/data/"
